...
# Unxccomment the following line to disable bi-weekly auto-update checks.
...
export PATH="/usr/local/sbin:$PATH:/usr/local/opt/ruby/bin:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools"
